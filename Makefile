...
ACLOCAL = ${SHELL} /www/tmp/engine/distr/protobuf-2.5.0/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /www/tmp/engine/distr/protobuf-2.5.0/missing --run autoconf
AUTOHEADER = ${SHELL} /www/tmp/engine/distr/protobuf-2.5.0/missing --run autoheader
AUTOMAKE = ${SHELL} /www/tmp/engine/distr/protobuf-2.5.0/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /www/tmp/engine/distr/protobuf-2.5.0/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 2.5.0
abs_builddir = /www/tmp/engine/distr/protobuf-2.5.0
abs_srcdir = /www/tmp/engine/distr/protobuf-2.5.0
abs_top_builddir = /www/tmp/engine/distr/protobuf-2.5.0
abs_top_srcdir = /www/tmp/engine/distr/protobuf-2.5.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /www/tmp/engine/distr/protobuf-2.5.0/install-sh
...
pdfdir = ${docdir}
prefix = /www/tmp/engine/install/protobuf
